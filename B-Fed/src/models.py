...
# EfficientNet-B0
## EfficientNet-B0 was imported from the package EfficientNet-PyTorch created by lukemelas
### The original GitHub address of the package is as follows:
### https://github.com/lukemelas/EfficientNet-PyTorch.git
### PyPi Download
### pip install efficientnet_pytorch
# Note: EfficientNet-B0 is not pretrained